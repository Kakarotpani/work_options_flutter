...
class ClientProfileUpload extends StatefulWidget {
  const ClientProfileUpload({ Key? key }) : super(key: key);

  @override
  State<ClientProfileUpload> createState() => _ClientProfileUploadState();
}

class _ClientProfileUploadState extends State<ClientProfileUpload> {
  ...
  _putProfile() async{
    final api = apiRoutes['client_profile_post'].toString();
    ...
    dynamic res = await NetworkServices().clientProfileUpload(api, body);
    showDialog(
      context: context,
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    ,),
                    onTap: () => Navigator.of(context).pushNamed('/client/profile/view'),
                  )
                ]
              )
            )
